    ...
    return (
        ...
        <li class="header__navbar-item header__navbar-item--bold">Đăng nhập</li> */}
                        <li className="header__navbar-item header__navbar-user">
                            ...
                            <span className="header__navbar-user-name">{authFakeLocal.user}</span>
                ...
                <div className="header-with-search">
                    ...
                    <div className="header__cart">
                        <div className="header__cart-wrap">
                            ...
                            <span className="header__cart-notice">{props.cartItem !== undefined ? props.cartItem.length : 0}</span>
                            <div className="header__cart-list">
                                ...
                                <ul className="header__cart-list-item">
                                    {props.cartItem !== undefined ? props.cartItem.map((item, indexItem) => {
                                        return (
                                            <li className="header__cart-item" indexItem={indexItem}>
                                                <img src={item.href} alt="Bộ kem sáng da mềm mịn" className="header__cart-img" />
                                                <div className="header__cart-item-info">
                                                    <div className="header__cart-item-head">
                                                        <h5 className="header__cart-item-name">{item.category}</h5>
                                ...
                                <div className="header__cart-view-cart">
                                    ...
                                    <button disabled={props.cartItem !== undefined && props.cartItem.length > 1 ? false : true} className="header__cart-btn btn btn--primary" onClick={() => {
                                        history.push({
                                            pathname: '/CartProduct',
                                            state: { listOrder: props.cartItem }
                                        })
                                    }}>Xem tat ca</button>
                                </div>
                            </div>
